...
from lapy import Solver, TetMesh, heat
...
def test_evals_evec_dimension(load_tet_mesh, loaded_data):
    ...
    expected_evals_len = loaded_data['expected_outcomes']['test_TetMesh_Geodesics']['expected_evals_len']
...
def test_gradients_normalization_and_divergence(load_tet_mesh, loaded_data):
    ...
    expected_max_col_values = loaded_data['expected_outcomes']['test_TetMesh_Geodesics']['expected_max_col_values']
    expected_min_col_values = loaded_data['expected_outcomes']['test_TetMesh_Geodesics']['expected_min_col_values']


    # Assert that the maximum and minimum values of each column of X match the expected values
...
def test_tetMesh_Geodesics_format(loaded_data):
    ...
    """
    expected_matrix_format = loaded_data['expected_outcomes']['test_TetMesh_Geodesics']['expected_matrix_format']
    ...
    expected_max_x = loaded_data['expected_outcomes']['test_TetMesh_Geodesics']['max_distance']
    ...
    expected_divx = loaded_data['expected_outcomes']['test_TetMesh_Geodesics']['expected_divx']
