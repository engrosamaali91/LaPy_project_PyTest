...
def test_normal_offset(tria_mesh_fixture, loaded_data):
    ...
    expected_result_offset = np.array(
        loaded_data["expected_outcomes"]["test_tria_mesh"]["expected_result_offset"]
    )
    np.testing.assert_allclose(computed_normal_offset, expected_result_offset)
